...
public:
     ...
     */
    void loadSVM(const char* model_path, Size armorImgSize = Size(64, 64));
    ...
    */
     ...
     */
    void getTargetInfo(vector<Point2f>& armorVertices, Point2f& centerPoint, ArmorType& type, bool& flag_Num);
