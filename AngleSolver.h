...
public :
    ...
    */
    void setTarget(vector<Point2f> contoursPoints, Point2f centerPoint, ArmorType type,bool flag_Num);
    ...
    */
    void P4P_solver();
    //void P4P_solver2(float x, float y,float z);

    /*
    * @brief solve the angles using PinHole method
    */
    void PinHole_solver( Mat cam, Mat dis,  Point2f centerPoint);
    ...
    */
    void
    getAngle(vector<Point2f>& contourPoints, Point2f centerPoint, ArmorType type, bool flag_Num, double & yaw, double & pitch, double & evaluateDistance,Point2f& precenter);
